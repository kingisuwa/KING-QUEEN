...
if (Config.WORKTYPE == 'private') {
   ...
   Asena.newcmdaddtosew({pattern: 'brandlogo ?(.*)', fromMe: true, dontAdCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
    ...
    await message.client.sendMessage(message.jid,Buffer.from(sewimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*' + Config.CPK + '*' })
     ...
     Asena.newcmdaddtosew({ pattern: 'wetglass ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'color3d ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'gold3d ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '2galaxy ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '3galaxy ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '2flower ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'puppy ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'royal ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '4galaxy ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'writegalacy ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'textby ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '3dwood ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'stars ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '1cake ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'glitter ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'noel ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'logometal ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'greenbush ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'glossy ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '2green ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '1holo ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'heart ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '5galaxy ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '2cake ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({pattern: 'brandlogo ?(.*)', fromMe: false, dontAdCommandList: true}, (async (message, match) => {
  ...
  var topText, bottomText;
    ...
    await message.client.sendMessage(message.jid,Buffer.from(sewimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '*' + Config.CPK + '*' })
     ...
     Asena.newcmdaddtosew({ pattern: 'wetglass ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'color3d ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'gold3d ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '2galaxy ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '3galaxy ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '2flower ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'puppy ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'royal ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '4galaxy ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'writegalacy ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'textby ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '3dwood ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'stars ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '1cake ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'glitter ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'noel ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'logometal ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'greenbush ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'glossy ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '2green ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '1holo ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'heart ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '5galaxy ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: '2cake ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
