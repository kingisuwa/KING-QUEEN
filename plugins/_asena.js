...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.newcmdaddtosew({pattern: 'asena ?(.*)', fromMe: true, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        Asena.commands.map(
            async (command) =>  {
    ...
    Asena.newcmdaddtosew({pattern: 'SEW ?(.*)', fromMe: true, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        Asena.commands.map(
            async (command) =>  {
...
Asena.newcmdaddtosew({pattern: 'help ?(.*)', fromMe: false, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        Asena.commands.map(
            async (command) =>  {
...
Asena.newcmdaddtosew({pattern: 'king ?(.*)', fromMe: false, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        Asena.commands.map(
            async (command) =>  {
...
Asena.newcmdaddtosew({pattern: 'menu ?(.*)', fromMe: false, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        Asena.commands.map(
            async (command) =>  {
...
Asena.newcmdaddtosew({pattern: 'cmd ?(.*)', fromMe: false, dontAdCommandList: true}, (async (message, match) => {
    var CMD_HELP = '';
    if (match[1] === '') {
        Asena.commands.map(
            async (command) =>  {
