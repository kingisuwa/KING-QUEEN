...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.newcmdaddtosew({ pattern: 'logogalaxy ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'logov2 ?(.*)', fromMe: true,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'gamelogo ?(.*)', fromMe: true, dontAdCommandList: true}, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'logogalaxy ?(.*)', fromMe: false,dontAdCommandList: true}, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'logov2 ?(.*)', fromMe: false,dontAdCommandList: true }, (async (message, match) => {
    ...
    Asena.newcmdaddtosew({ pattern: 'gamelogo ?(.*)', fromMe: false, dontAdCommandList: true}, (async (message, match) => {
