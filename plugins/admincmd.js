...
if (Config.LANG == 'EN') {
Asena.newcmdaddtosew({pattern: 'admin$', fromMe: true, delownsewcmd: false, desc: 'all admin command'}, (async (message, match) => {
...
if (Config.LANG == 'SI') {
Asena.newcmdaddtosew({pattern: 'admin$', fromMe: true, delownsewcmd: false, desc: 'ඇඩ්මින් කමාන්ඩ් ලබා දේ'}, (async (message, match) => {
...
Asena.newcmdaddtosew({pattern: 'configvar$', fromMe: true, delownsewcmd: false, desc: 'all admin command'}, (async (message, match) => {
